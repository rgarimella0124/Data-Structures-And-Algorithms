...
public class Solution {
    ...
    /*
     * This method checks whether a year is leap or not by using Java Date and Time
     * API. Calendar class has utility method to return maximum number of days in a
     * year which can be used to check if its greater than 365 or not
     */
