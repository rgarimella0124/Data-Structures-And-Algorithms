...
/**
 * Java program to show you how to check if a String is palindrome or not. An
 * String is said to be palindrome if it is equal to itself after reversing. In
 * this program, you will learn how to check if a string is a palindrome in java
 * using recursion and for loop both.
 */
